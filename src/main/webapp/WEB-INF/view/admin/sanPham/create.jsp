        ...
        <div class="animated fadeIn">
            <div class="card col-lg-12">
                <div class="card-header">
                    <div>
                        <strong class="card-title" ><h3>Thêm mới giày</h3></strong>
                    </div>
                </div>
                <div class="card-body">
                    <sf:form action="/san-pham/them" method="post" modelAttribute="sanPham" class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            ...
                            <c:if test="${trungTen==true}">
                                <p class="text-danger">Tên sản phẩm đã có trong hệ thống, vui lòng nhập tên mới</p>
                            </c:if>
                        </div>
        ...
        <div class="animated fadeIn">
            <div class="card col-lg-12">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-10">
                            <strong class="card-title" ><h3>Danh sách tên sản phẩm</h3></strong>
                        </div>
                    </div>
                    <br>
...
<%--<c:if test="${chuaChonLuaChonDeXoa==true}">--%>
<%--    <div id="messageAlertDeleteWarning" class="alert alert-warning alert-dismissible" style="z-index: 9999; position: fixed; top: 10px; right: 10px; width: 350px;">--%>
<%--        <button type="button" class="close" data-dismiss="alert">&times;</button>--%>
<%--        Vui lòng chọn các sản phẩm bạn muốn xóa !--%>
<%--    </div>--%>

<%--    <script>--%>
<%--        // Lấy thẻ alert--%>
<%--        var alert = document.getElementById('messageAlertDeleteWarning');--%>
...
<%--function kiemTraDaChonGiaTriDeXoaChua() {--%>
<%--var checkboxes = document.querySelectorAll('.checkBoxLuaChonXoa');--%>
<%--var size = checkboxes.length;--%>

<%--if (size>=1) {--%>
<%--var confirmation = confirm('Bạn chắc chắn muốn xóa các sản phẩm đã chọn ?');--%>
<%--if (confirmation) {--%>
<%--console.log("Đã xác nhận confirm");--%>
<%--} else {--%>
<%--// Xử lý khi hủy bỏ confirm--%>
<%--console.log("Hủy bỏ confirm");--%>
<%--}--%>
<%--} else {--%>
<%--alert('Không có checkbox được chọn.');--%>
<%--}--%>
<%--}--%>
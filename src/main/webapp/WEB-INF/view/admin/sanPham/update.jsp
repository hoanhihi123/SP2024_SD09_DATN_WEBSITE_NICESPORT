                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Sửa thông tin tên sản phẩm</li>
                                </ol>
                            </div>
                        </div>
                    </div>
            ...
            <div class="animated fadeIn">
                    <div class="card col-lg-12">
                        <div class="card-header">
                            <div>
                                    <strong class="card-title" ><h3>Sửa thông tin tên sản phẩm</h3></strong>
                            </div>

                        </div>
                        <div class="card-body">
                                <sf:form action="/san-pham/sua/${sanPham.id}" method="post" modelAttribute="sanPham" class="row">
                                    <div class="col-lg-6">

            ...
            <div class="col-lg-12">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#hoaDonCho1" type="button" role="tab" aria-controls="home" aria-selected="true">Hóa đơn 1</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#hoaDonCho2" type="button" role="tab" aria-controls="profile" aria-selected="false">Hóa đơn 2</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#hoaDonCho3" type="button" role="tab" aria-controls="contact" aria-selected="false">Hóa đơn 3</button>
                    </li>
                </ul>
            </div>
            <div class="col-lg-12">
                <div class="tab-content row" id="myTabContent">
                    <div class="tab-pane fade show active" id="hoaDonCho1" role="tabpanel" aria-labelledby="home-tab">
                        <!-- Tab 1
                         -->
...
<%--                                                                                                        <td > <a href="#" class="btn btn-success"> Chọn mua</a> </td>--%>
<%--                                                                                                </tr>--%>
<%--                                                                                            </c:forEach>--%>
                                                                                        </tbody>
                                                                                    </table>
